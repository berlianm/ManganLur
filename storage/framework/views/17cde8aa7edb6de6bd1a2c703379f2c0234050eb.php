                        ...
                        <div class="row g-0">
                            <div class="col-lg-6">
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <form action="/masuk" method="POST" class="my-3">
                                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php if(session()->has('loginErorr')): ?>
        <script>
            toastr.error(`<?php echo e(session('loginErorr')); ?>`);
        </script>
    <?php endif; ?>
...
<?php /**PATH E:\laragon\www\JOKI\manganlur\resources\views/content/login/loginUser.blade.php ENDPATH**/ ?>