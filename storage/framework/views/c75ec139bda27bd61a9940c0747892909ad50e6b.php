...
unset($__errorArgs, $__bag); ?>"
                                                name="nama" placeholder="Enter Your Name" value="<?php echo e(old("nama")); ?>"/>
                                            <?php $__errorArgs = ['nama'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>"
                                                name="email" placeholder="Enter Your Email" value="<?php echo e(old("email")); ?>"/>
...
<?php /**PATH E:\laragon\www\JOKI\manganlur\resources\views/content/register.blade.php ENDPATH**/ ?>